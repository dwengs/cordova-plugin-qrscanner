...
// is made transparent.
function changeBackground(to = 'transparent') {
    var body = document.body;
    if(body){
      if(to == 'transparent'){
        body.classList.add('qrscanner-active');
        if (body.style) {
          ...
          if (body.parentNode && body.parentNode.style) {
            body.parentNode.classList.add('qrscanner-active');
        ...
        body.classList.remove('qrscanner-active');
        if (body.style) {
          body.style.backgroundColor = '';
          body.style.backgroundImage = '';
          if (body.parentNode && body.parentNode.style) {
            body.parentNode.classList.remove('qrscanner-active');
...
function doneCallback(callback, changeTo) {
  if (!callback) {
    return null;
  }
  return function(statusDict) {
    if (changeTo) {
      changeBackground(changeTo);
    }
...
return {
  ...
  destroy: function(callback) {
    cordova.exec(doneCallback(callback, 'opaque'), null, 'QRScanner', 'destroy', []);
  },
  ...
  show: function(callback) {
    cordova.exec(doneCallback(callback, 'transparent'), null, 'QRScanner', 'show', []);
  },
  hide: function(callback) {
    cordova.exec(doneCallback(callback, 'opaque'), null, 'QRScanner', 'hide', []);
  },
